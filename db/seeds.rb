...
# 50 Funds
Fund.insert_all(Array.new(50) { |i| { title: "Fund #{i + 1}", total: rand(10..50) * 1000 } }) # rubocop:disable Rails/SkipsModelValidations
fund_ids = Fund.ids

# 100 Projects
Project.insert_all( # rubocop:disable Rails/SkipsModelValidations
  Array.new(100) { |i| { title: "Project #{i + 1}", fund_id: fund_ids.sample } }
)
